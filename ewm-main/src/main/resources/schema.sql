...
--     CONSTRAINT EVENTS_CATEGORIES_ID_FK FOREIGN KEY (CATEGORY_ID)
--     REFERENCES CATEGORIES (ID) ON DELETE CASCADE,
--     CONSTRAINT EVENTS_LOCATIONS_ID_FK FOREIGN KEY (LOCATION_ID)
--     REFERENCES LOCATIONS (ID) ON DELETE CASCADE,
--     CONSTRAINT EVENTS_USERS_ID_FK FOREIGN KEY (INITIATOR_ID)
...
--     );
--
-- -- таблица связи между events и compilations
